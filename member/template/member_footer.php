<nav class="fixed bottom-0 left-0 right-0 bg-white shadow-lg">
    <div class="container mx-auto px-4 py-2 flex justify-around items-center max-w-full md:max-w-[650px]">
        ...
        <a href="member_dashboard.php" class="flex flex-col items-center px-3 py-2 text-sm font-medium border-blue-600 border-2 rounded-full <?php echo basename($_SERVER['PHP_SELF']) == 'member_dashboard.php' ? 'bg-blue-600 text-white' : 'text-gray-500 hover:text-gray-700'; ?>">
            <div class="w-6 h-6 flex items-center justify-center mb-1">
